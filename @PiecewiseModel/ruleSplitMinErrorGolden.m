function [varIdx, newBound1, newBound2, data] = ruleSplitMinErrorGolden(obj, varList, data)
% Fit each subdomain with a 2norm quadratic model.
% Variable which led to the smallest 2norm error is the varIdx to be
% split by the golden ratio.
